...
const CowItUpPage: NextPage = () => {
	...
	return <Wrap>
		<Logo><img alt="" src="/assets/ciu/logo_ciu.png" /><CowLogo><img alt="" src={`/assets/ciu/${width767 ? 'icon_ciu_2' : 'icon_ciu_3'}.png`} /></CowLogo></Logo>
		<Inner>
			<BoxButton>
				<Link href="https://apps.apple.com/us/app/cow-it-up-match-tiles/id1660692083" style={{
					marginRight: width767 ? '14px' : '32px',
				}} target='_blank'><img alt="" src="/assets/ciu/AppStore.png" /></Link>
				<Link href="https://play.google.com/store/apps/details?id=cowitup.casual" target='_blank'><img alt="" src="/assets/ciu/PlayStore.png" /></Link>
			</BoxButton>
			<BoxBody>
				<BodyLeft>
					...
					}}><img alt="" src="/assets/ciu/icon_ciu_1.png" /></Box>}
				</BodyLeft>
				<BodyRight>
					<iframe width="560" height="315" src="https://www.youtube.com/embed/QKxb_IJ1xqY?&autoplay=1&mute=1&loop=1&playlist=QKxb_IJ1xqY" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
					{!width767 && <Box sx={{
						textAlign: 'right',
						marginRight: '20px',
						marginTop: '-20px'
					}}><img alt="" src="/assets/ciu/icon_ciu_4.png" /></Box>}
				</BodyRight>
				{width767 && <Box>
					To start the tile-matching game is very easy. Your job is to eliminate all the patterns on the screen by adding them to the grid below.<br></br><br></br>
					However, winning the match 3 game is nearly equal to asking for the moon! How so?
			...
			<BoxFooter>
				<Box sx={{
					marginRight: '24px'
				}}><img alt="" src="/assets/ciu/logo_versehub.png" /></Box>
				<BoxPolicy>
