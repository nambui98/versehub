...
const CowItUpPolicyPage: NextPage = () => {
	...
	return <Wrap>
		{width767 && <Logo><img src="/assets/ciu/logo_ciu.png" alt="" /><CowLogo><img alt="" src={`/assets/ciu/${width767 ? "icon_ciu_2" : "icon_ciu_3"}.png`} /></CowLogo></Logo>}
		{!width767 && <Box sx={{
			maxWidth: 800,
			padding: "0 15px",
			margin: 'auto',
		...
		}}><img width={'100%'} src="/assets/ciu/logo_group.png" alt="" /></Box>}
		<Inner>
			...
			<Body>
				...
				<Email><img alt="" src="/assets/ciu/email.png" /> cowitup01@gmail.com</Email>
		...
		<ScrollToTop onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}><img alt="" src="/assets/ciu/scroll_top.png" /></ScrollToTop>
	</Wrap>
}
