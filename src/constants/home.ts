...
export const PRODUCT = {
	title: 'release',
	items: [
		{ src: '/assets/products/city.png', title: 'Coming soon', active: false },
		{ src: '/assets/products/nextverse-logo.png', title: 'Nextverse', active: true },
		{ src: '/assets/products/city.png', title: 'Coming soon', active: false },
		{ src: '/assets/products/city.png', title: 'Coming soon', active: false },
		{ src: '/assets/products/city.png', title: 'Coming soon', active: false },
		{ src: '/assets/products/city.png', title: 'Coming soon', active: false },
...
export const PARTNER = {
	title: 'partners',
	items: [
		{ src: '/assets/partners/coming.png', title: 'Coming soon', active: false },
		{ src: '/assets/partners/icetealabs_logo_text.png', title: '', active: true },
		{ src: '/assets/partners/coming.png', title: 'Coming soon', active: false },
		{ src: '/assets/partners/coming.png', title: 'Coming soon', active: false },
		{ src: '/assets/partners/coming.png', title: 'Coming soon', active: false },
		{ src: '/assets/partners/coming.png', title: 'Coming soon', active: false },
...
export const TEAM = {
	...
	items: [
		...
		{ src: '/assets/teams/profile3.png', name: 'Anh Do', title: 'CPO & MARKETING DIRECTOR' },
		{ src: '/assets/teams/profile4.png', name: 'Cong Nguyen', title: 'CFO' },
		{ src: '/assets/teams/profile5.png', name: 'Jolly', title: 'Tech Lead' },
...
export const JOB = {
	...
	subtitle: 'Excellent products need excellent people. Our pioneering team is looking for new members to join the fleet.',
