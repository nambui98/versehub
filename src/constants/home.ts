...
export const SERVICE = {
	...
	items: [
		{
			src: "/assets/missions/mission1.webp",
		...
		{
			src: "/assets/missions/mission2.webp",
		...
		{
			src: "/assets/missions/mission3.webp",
			title: "Web3",
		...
		{
			src: "/assets/missions/mission4.webp",
...
export const PARTNER = {
	...
	items: [
		{
			src: "/assets/partners/house3d.png",
			title: "",
			active: true,
			width: "35%",
		},
		{
			src: "/assets/partners/icetealabs.png",
			title: "",
			active: true,
			width: "35%",
		},
		{
			src: "/assets/partners/cyradar.png",
			title: "",
			active: true,
			width: "60%",
		},
		{
			src: "/assets/partners/coming.png",
			title: "Coming soon",
			active: false,
			width: "20%",
		},
	...
	items: [
		...
		},
		{
			...
			desc: [
				...
				`3 years of managing online payment projects`,
		...
		},
		{
			...
			desc: [
				...
				`4 years' experience developer managing`,
			],
		},
		{
			src: "/assets/teams/profile5.jpg",
			name: "Hung Nguyen",
			title: "Head of Blockchain Development",
			desc: [
				`8 years' experience in full software development lifecycle`,
				`Advanced in of C/C++, Python, algorithm design and analysis`,
			],
		},
		{
			src: "/assets/teams/profile6.jpg",
			name: "Tuyen Nguyen",
			title: "Head of VR/3D R&D",
			desc: [
				`10 years' experience in developing mobile games on various engines (unity, cocos2d-x...)`,
			],
		},
		{
			src: "/assets/teams/profile7.jpg",
			name: "Duyet Duong",
			title: "Art Director",
			desc: [
				`10 years' experience in design`,
				`6 years' experience in game product art management and direction`,
			],
		},
		{
			src: "/assets/teams/profile8.jpg",
			name: "Biba",
		...
		},
		{
			...
			name: "50+",
			title:
				"The team is growing up, check out our careers page for job opportunities",
		},
	],
};
